        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferencePayDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ExpectedAnnualSalaryRaisePercentage = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ExpectedAnnualInflationPercentage = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedAnnualGrowthPercentage = table.Column<decimal>(type: "decimal(18,4)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FinanceSnapshotId = table.Column<int>(type: "int", nullable: false),
